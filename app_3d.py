...
# Traductions dynamiques (TITRE AJOUTÉ ICI)
T = {
...
# --- AFFICHAGE PRINCIPAL ---
st.title(T[L]["title"]) # LE TITRE EST MAINTENANT BILINGUE
...
if mode == "1. Point Unique / Single Point":
    ...
    delays_ns, points_i = calc.compute_fermat_3d(tx, ty, fz)
    ...
    with c2:
        ...
        st.dataframe(delays_ns.reshape(nx, ny).astype(int))
